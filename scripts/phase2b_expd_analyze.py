...
CAPS = [
    ("ours_0.23M", "experiments/phase2c/expA_equal_budget/static_eb_s0_eval"),  # baseline compact
    ("ours_0.5M", "experiments/phase2b/expD_compact_z/ours_0.5M_eval"),
    ("ours_1.0M", "experiments/phase2b/expD_compact_z/ours_1.0M_eval"),
    ("ours_2.0M", "experiments/phase2b/expD_compact_z/ours_2.0M_eval"),
]
