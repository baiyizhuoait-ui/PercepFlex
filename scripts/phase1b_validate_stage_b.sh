...
A_CKPT=${1:-experiments/phase1b/exp_train_a/checkpoint.pt}
N=${2:-8000}
OUT=experiments/phase1b/exp_train_b_val
$PY training/train.py --config configs/phase1b_train_stage_b.yaml --num-images "$N" --epochs 1 \
