...
$PY training/train.py --config configs/phase1b_train_stage_b.yaml \
...
$PY training/train.py --config configs/phase1b_train_stage_c.yaml \
...
$PY training/train.py --config configs/phase1b_train_stage_d.yaml \
