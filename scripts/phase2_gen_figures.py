...
def main():
    ...
    for tag, path, flops in [
        ("static_tiny", "experiments/phase1b/exp_static_vs_dynamic/static_tiny/metrics.json", 0.783),
        ("static_medium", "experiments/phase1b/exp_static_vs_dynamic/static_medium/metrics.json", 0.924),
        ("static_large", "experiments/phase1b/exp_static_vs_dynamic/static_large/metrics.json", 1.473),
        ("dynamic", "experiments/phase1b/exp_static_vs_dynamic/dynamic/metrics.json", 0.90),
        ("static_eb", "experiments/phase2c/expA_equal_budget/static_eb_s0_eval/metrics.json", 0.924),
    ]:
        m = load(path)
        if m:
    ...
    caps = []
    for tag, path in [
        ("0.23M", "experiments/phase2c/expA_equal_budget/static_eb_s0_eval/metrics.json"),
        ("0.5M", "experiments/phase2b/expD_compact_z/ours_0.5M_eval/metrics.json"),
        ("1.0M", "experiments/phase2b/expD_compact_z/ours_1.0M_eval/metrics.json"),
        ("2.0M", "experiments/phase2b/expD_compact_z/ours_2.0M_eval/metrics.json"),
    ]:
        m = load(path)
        if m:
