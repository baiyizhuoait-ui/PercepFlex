...
MODELS = [
    ("no_kd", "experiments/phase1b/exp_train_a/eval_full", "0.235M"),
    ("kd_yolop_off10", "experiments/phase2b/expF_single_teacher/kd_yolop_off10_eval", "0.235M"),
    ("kd_twinlite_off10", "experiments/phase2b/expF_single_teacher/kd_twinlite_off10_eval", "0.235M"),
    ("kd_trilite_off10", "experiments/phase2b/expF_single_teacher/kd_trilite_off10_eval", "0.235M"),
    ("kd_yolop_online", "experiments/phase2b/expF_single_teacher/kd_yolop_eval", "0.235M"),
]
