...
$PY training/train.py --config configs/phase1b_train_stage_a.yaml --num-images "$IMAGES" --epochs "$EPOCHS_A" \
...
$PY training/train.py --config configs/phase1b_train_stage_b.yaml --num-images "$IMAGES" --epochs "$EPOCHS_B" \
...
$PY training/train.py --config configs/phase1b_train_stage_c.yaml --num-images "$IMAGES" --epochs "$EPOCHS_C" \
...
$PY training/train.py --config configs/phase1b_train_stage_d.yaml --num-images "$IMAGES" --epochs "$EPOCHS_D" \
